...
container.setAttribute(
  "class",
  "container-fluid d-flex justify-content-center py-10"
);
...
function validateAndDisplayTheData() {
  ...
  checkedcheckboxs = document.querySelectorAll(
...
function displayTheData(selectedGender) {
  ...
  let selectedFoods = Array.from(checkedcheckboxs).map((checkbox) =>
